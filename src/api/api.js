...
function getOptions(method = 'get', body) {
    const options = {
        method,
        headers: {
            'X-Parse-Application-Id': 'gMN6SgZ0UtZJmyAVjNJN7hCpk1VyRNxbjTBhI4kk',
            'X-Parse-REST-API-Key': 'kr0GM6E7Rqql0x3D6erFPMHSr6eak8Q7jw5QDnHW'
        }
    };
...
export async function logout() {
    ...
    sessionStorage.removeItem('authToken', result.sessionToken)
